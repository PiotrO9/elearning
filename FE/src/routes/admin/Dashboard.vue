    ...
    <div class="min-h-screen bg-gray-50">
        ...
        <MaxWidthWrapper class="py-8 flex flex-col gap-6">
            ...
            <div v-if="isLoading" class="text-center py-12">
                <div
                    class="inline-block animate-spin rounded-full h-12 w-12 border-4 border-gray-300 border-t-purple-600"
                ></div>
            ...
            <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                >
                    <div class="flex items-center justify-between">
                        <div class="flex-1">
                            ...
                            <p
                                class="text-3xl font-bold text-gray-900 group-hover:text-purple-700 transition-colors"
                            >
                                {{ stats.totalCourses }}
                            </p>
                        </div>
                        <div
                            class="w-12 h-12 bg-blue-50 rounded-full flex items-center justify-center group-hover:bg-blue-100 transition-colors"
                        >
                            <Icon name="books" class="w-6 h-6 text-blue-600" />
                        </div>
                    </div>
                </div>
                ...
                >
                    <div class="flex items-center justify-between">
                        <div class="flex-1">
                            ...
                            <p
                                class="text-3xl font-bold text-gray-900 group-hover:text-green-700 transition-colors"
                            >
                                {{ stats.activeCourses }}
                            </p>
                        </div>
                        <div
                            class="w-12 h-12 bg-green-50 rounded-full flex items-center justify-center group-hover:bg-green-100 transition-colors"
                        >
                            <Icon name="check" class="w-6 h-6 text-green-600" />
                        </div>
                    </div>
                </div>
                ...
                >
                    <div class="flex items-center justify-between">
                        ...
                        <div
                            class="w-12 h-12 bg-purple-50 rounded-full flex items-center justify-center group-hover:bg-purple-100 transition-colors"
                        >
                ...
                >
                    <div class="flex items-center justify-between">
                        <div class="flex-1">
                            ...
                            <p
                                class="text-3xl font-bold text-gray-900 group-hover:text-orange-700 transition-colors"
                            >
                                {{ stats.totalTags }}
                            </p>
                        </div>
                        <div
                            class="w-12 h-12 bg-orange-50 rounded-full flex items-center justify-center group-hover:bg-orange-100 transition-colors"
                        >
                            <Icon name="tags" class="w-6 h-6 text-orange-600" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div v-if="!isLoading" class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div class="lg:col-span-2 bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        >
                            <div
                                class="w-14 h-14 bg-blue-100 rounded-full flex items-center justify-center mb-3 group-hover:bg-blue-200 transition-colors"
                            >
                                <Icon name="books" class="w-7 h-7 text-blue-600" />
                            </div>
                            <span
                                class="font-semibold text-gray-900 group-hover:text-blue-700 transition-colors"
                                >Zarządzaj kursami</span
                            >
                        </router-link>
                        ...
                        >
                            <div
                                class="w-14 h-14 bg-green-100 rounded-full flex items-center justify-center mb-3 group-hover:bg-green-200 transition-colors"
                            >
                                <Icon name="tags" class="w-7 h-7 text-green-600" />
                            </div>
                            <span
                                class="font-semibold text-gray-900 group-hover:text-green-700 transition-colors"
                                >Zarządzaj tagami</span
                            >
                        </router-link>
                        <router-link
                            to="/admin/tags"
                        ...
                        <router-link
                            ...
                            class="flex flex-col items-center p-6 bg-yellow-50 rounded-lg hover:bg-yellow-100 hover:shadow-md transition-all duration-200 group border border-yellow-100"
                            tabindex="0"
                            aria-label="Zarządzaj banerami logowania"
                        >
                            <div
                                class="w-14 h-14 bg-yellow-100 rounded-full flex items-center justify-center mb-3 group-hover:bg-yellow-200 transition-colors"
                            >
                                <Icon name="users" class="w-7 h-7 text-purple-600" />
                            </div>
                            <span
                                class="font-semibold text-gray-900 group-hover:text-purple-700 transition-colors"
                                >Zarządzaj banerami</span
                            >
                        </router-link>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div v-if="recentActivities.length === 0" class="text-center py-8">
                        <Icon name="empty" class="w-12 h-12 text-gray-300 mx-auto mb-3" />
