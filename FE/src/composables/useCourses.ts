  ...
  const mockCourses: Course[] = [
    {
      ...
      description: 'Naucz się tworzyć nowoczesne aplikacje webowe używając Vue 3, Composition API i TypeScript od podstaw do zaawansowanych technik.',
    ...
    },
    {
      ...
      description: 'Poznaj zasady projektowania interfejsów użytkownika i doświadczenia użytkownika. Stwórz portfolio projektów.',
    ...
    },
    {
      ...
      description: 'Kompleksowy przewodnik po marketingu w mediach społecznościowych. Praktyczne strategie i narzędzia.',
    ...
    },
    {
      ...
      description: 'Twórz skalowalne aplikacje backendowe używając Node.js, Express i MongoDB. Poznaj REST API i GraphQL.',
    ...
    },
    {
      ...
      description: 'Naucz się robić profesjonalne zdjęcia produktów. Oświetlenie, kompozycja, obróbka zdjęć.',
    ...
    },
    {
      ...
      description: 'Poznaj metodyki Agile, Scrum i Kanban. Naucz się efektywnie zarządzać zespołem i projektami.',
    ...
    },
    {
      ...
      description: 'Analiza danych z Python. Pandas, NumPy, Matplotlib i wprowadzenie do Machine Learning.',
    ...
    },
    {
      ...
      description: 'Od modelowania przez teksturowanie po rendering. Stwórz swoje pierwsze projekty 3D.',
